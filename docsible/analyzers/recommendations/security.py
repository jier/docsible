            ...
            try:
                ...
                for idx, task in enumerate(tasks):
                    ...
                    if task.get("debug"):
                        ...
                        var_match = (
                            any(pattern in var.lower() for pattern in sensitive_patterns)
                            if var
                            else False
                        )
                        msg_match = (
                            any(pattern in str(msg).lower() for pattern in sensitive_patterns)
                            if msg
                            else False
                        )
            ...
            try:
                ...
                for idx, task in enumerate(tasks, 1):
                    ...
                    if "file" in task:
                        ...
                        module_params = (
                            task["template"] if isinstance(task["template"], dict) else {}
                        )
