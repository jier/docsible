...
class RenderConfig(BaseModel):
    ...
    backup: bool = Field(default=True, description="Create backup before overwriting")
    markdown_validation: bool = Field(default=True, description="Run markdown validation")
    auto_fix: bool = Field(default=False, description="Auto-fix markdown issues")
    strict_validation: bool = Field(default=False, description="Fail on validation errors")
