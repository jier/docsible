...
TEST_CASES = [
    ...
    (
        "https://user:p@ss:w%20rd!$*()@gitlab.com/group/project.git",
        "https://gitlab.com/group/project",
    ),
    # Complex password with an @ symbol
    (
        "https://user:secretp@ss@bitbucket.org/team/repo",
    ...
    # Non-standard port
    (
        "https://user:pass@host.com:8443/path/to/repo.git",
        "https://host.com:8443/path/to/repo",
    ),
    # SCP-like syntax
    ...
    (
        "ssh://user:p@ss:w%20rd!$*()%2FD%2F%E0%E7890_*%2F%2F%27(%27(%27(%27(%5C@gitea.com/owner/repo.git",
