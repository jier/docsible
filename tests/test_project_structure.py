...
def test_standard_role_detection():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        assert project.project_type == "role", (
            f"Expected 'role', got '{project.project_type}'"
        )
...
def test_collection_detection():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        assert project.project_type == "collection", (
            f"Expected 'collection', got '{project.project_type}'"
        )
...
def test_monorepo_detection():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        assert project.project_type == "monorepo", (
            f"Expected 'monorepo', got '{project.project_type}'"
        )
...
def test_multi_role_detection():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        assert project.project_type == "multi-role", (
            f"Expected 'multi-role', got '{project.project_type}'"
        )
        assert project.get_roles_dir().name == "roles"
...
def test_awx_detection():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        assert project.project_type == "awx", (
            f"Expected 'awx', got '{project.project_type}'"
        )
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        assert project.project_type != "awx", (
            f"Expected NOT 'awx', got '{project.project_type}'"
        )
        assert project.project_type == "multi-role", (
            f"Expected 'multi-role', got '{project.project_type}'"
        )
